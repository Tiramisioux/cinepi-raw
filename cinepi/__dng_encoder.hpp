...
private:
	...
	static const int NUM_DISK_THREADS = 4;
	...
	size_t dng_save(int thread_num, uint8_t *mem_tiff, uint8_t const *mem, StreamInfo const &info, uint8_t const *lomem, StreamInfo const &loinfo, size_t losize,
