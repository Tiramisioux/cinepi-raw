...
void LibcameraApp::ConfigureVideo(unsigned int flags, uint8_t thumbnailFactor)
{
	...
	Size preview_size(configuration_->at(1).size.width >> 1, configuration_->at(1).size.height >> 1);
